...
//   // parent_id === selected main category → sub category
...
//     if (!validatePrices(form.purchase_price, form.base_price)) {
//       return;
//     }
...
//       const productId = res.data?.data?.product_id || res.data?.data?.id;
