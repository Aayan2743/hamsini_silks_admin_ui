...
export default function StepBasic({ setStep, setProductId }) {
  ...
  const subCategories = categories.filter(
    (c) => Number(c.parent_id) === Number(form.category_id),
  );
...
function SearchableSelect({ label, options, value, onChange, placeholder }) {
  ...
  return (
    <div className="space-y-1 relative w-full" ref={ref}>
      ...
      {open && (
        <div className="absolute left-0 top-full z-50 w-full mt-1 rounded-lg border bg-white shadow-lg">
